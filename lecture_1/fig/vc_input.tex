...
\node[strongpoint, right=7mm of raw]        (tech){Input data};
...
\path (raw.south) edge[strongarrow, bend right=45] node[below,strongannote,text width=6em] {Extract and coerce} (tech.south);
