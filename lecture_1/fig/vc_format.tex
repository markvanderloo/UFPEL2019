...
\node[strongpoint, right=7mm of estimate] (output){Output};
...
\path (estimate.south) edge[strongarrow, bend right=45] node[below,strongannote] {Format and SDC} (output.south);
\end{tikzpicture}
