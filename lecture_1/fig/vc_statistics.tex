...
\node[strongpoint, right=7mm of consistent] (estimate){Statistics};
...
\path (consistent.south) edge[strongarrow, bend right=45] node[below,strongannote, text width=5em]  {Analyze and infer} (estimate.south);
